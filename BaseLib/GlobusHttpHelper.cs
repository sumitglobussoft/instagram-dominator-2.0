...
namespace Globussoft
{
    public class GlobusHttpHelper
    {
        ...
        public string getHtmlfromUrlinta(Uri url, string referer ,string token)
        {
            string responseString = string.Empty;
            try
            {
...
X-CSRFToken: a85658f691e429a7518cf9e9d355d5ff
                 */
        ...
        public string GetData_LoginThroughInstagram(Uri url, string proxyAddress, string proxyPort, string ProxyUsername, string proxyPassword)
        {
            ...
            ///Modified BySumit 18-11-2011
            ChangeProxy(proxyAddress, proxyPortCopy, ProxyUsername, proxyPassword);
        ...
        public string GetData_WithInstagram(Uri url, string referer, string host)
        {
            gRequest = (HttpWebRequest)WebRequest.Create(url);
        ...
        public string PostDataWithInstagram(Uri url, string postData, string Referes)
        {
            gRequest = (HttpWebRequest)WebRequest.Create(url);
        ...
        public string postFormData_icon(Uri url, string postData, string Referes, string Token)
        {
        ...
        public string postFormDatainta(Uri url, string postData, string Referes, string Token)
        {
