...
namespace BaseLib
{
    public class DataBaseHandler
    {
        ...
        public static string CONstr = "Data Source=" + Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData) + "\\gramdominator_db_2.0\\GramDominator.db";
       // public static string CONstr = @"data source=C:\Users\GLB-117\Desktop\GramDominator 2.0(new)\GramDominator 2.0\GramDominator\bin\Debug\GramDominator.db";
        public static DataSet SelectQuery(string query, string tablename)
        {
            //try
            //{
            //CONstr = @"data source=C:\Users\GLB-111\Desktop\DataBase\DB_LinkedInDominator.db;Version=3;";
