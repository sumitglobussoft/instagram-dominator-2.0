...
namespace Globussoft
{
    ...
    {
        public static string path_AppDataFolder = Environment.GetFolderPath(Environment.SpecialFolder.Desktop) + "\\Gram Dominator";
        ...
        public static string hasBeenRequestedFilePath = path_AppDataFolder + "\\hasBeenRequested.txt";
        ...
        public static string ReadFiletoString(string filepath)
        {
            ...
            while ((text = reader.ReadLine()) != null)
            {
                if (!string.IsNullOrEmpty(text.Trim()))
                {
                    text1 = text1 + text.Replace("�", " ").Replace("\0", "");
                }
            }
            reader.Close();
            return text1;
